...
void* assignResource(void* ismalware_p)
{
	// Arg
	bool ismalware = (bool) ismalware_p;
...
int main()
{
    ...
    malware_id = pthread_create(&malware, NULL, &assignResource, (void*) true);
    normal_id = pthread_create(&normal, NULL, &assignResource, (void*) false);



	// Build a vector to create CSV file
