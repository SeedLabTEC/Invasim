...
VL_MODULE(Vtop_top) {
  public:
	...
	VL_SIG(__PVT__riscv_core_i__DOT__load_store_unit_i__DOT__data_wdata,31,0);
	...
	VL_SIG(__PVT__riscv_core_i__DOT__cs_registers_i__DOT__PCCR_q,31,0);
	VL_SIG(__PVT__riscv_core_i__DOT__cs_registers_i__DOT__PCCR_n,31,0);
  ...
  public:
    static void _multiclk__TOP__top__7(Vtop__Syms* __restrict vlSymsp);
    static void _multiclk__TOP__top__8(Vtop__Syms* __restrict vlSymsp);
