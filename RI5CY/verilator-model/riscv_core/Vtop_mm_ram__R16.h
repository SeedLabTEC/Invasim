...
#ifndef _Vtop_mm_ram__R16_H_
#define _Vtop_mm_ram__R16_H_
...
VL_MODULE(Vtop_mm_ram__R16) {
  public:
    ...
    VL_IN8(__PVT__irq_ack_i,0,0);
    VL_OUT8(__PVT__irq_id_o,4,0);
    VL_OUT8(__PVT__irq_o,0,0);
    VL_OUT8(__PVT__tests_passed_o,0,0);
    VL_OUT8(__PVT__tests_failed_o,0,0);
  ...
  public:
    ...
    // CONSTRUCTORS
  private:
    VL_UNCOPYABLE(Vtop_mm_ram__R16);  ///< Copying not allowed
  public:
    Vtop_mm_ram__R16(const char* name="TOP");
    ~Vtop_mm_ram__R16();
